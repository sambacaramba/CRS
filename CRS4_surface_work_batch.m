...
clear all 
%load paths file
%% used functions, FillHoles3D, CRS_surface_work_func
...
fn = [fn,'lateral'];
%% surface fitting 
surfvals = CRS_surface_work_func(lat_vol,fn, savefold,res_loc,voxel_size,offset_value,polX,polY,finetune,removal_threshold);
%%
...
fn = [fn,'medial'];
%% surface fitting
surfvals = CRS_surface_work_func(med_vol,fn, savefold,res_loc,voxel_size,offset_value,polX,polY,finetune,removal_threshold);
%%
save(strcat(savefold,['surfvals_',fn '.mat']),'surfvals');
